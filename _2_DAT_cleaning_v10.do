...
*** Find: "INSERT DATES OF INTEREST HERE" and update/change this list as per needs. I traditionally did this on a weekly basis (also because age is calculated weekly in case you need to subset more accurately), but you could do monthly dose count indicators instead.
 ...
 ******************************************
	...
	global IDI_CONN conn("Driver={SQL Server}; Trusted_Connection=YES; Server=SERVER_NAME,PORT;Database=$IDI_DB")
 
	global IDISP_CONN conn("Driver={SQL Server}; Trusted_Connection=YES; Server=SERVER_NAME,PORT;Database=$IDI_SP")
	
	global IDIAH_CONN conn("Driver={SQL Server}; Trusted_Connection=YES; Server=SERVER_NAME,PORT;Database=$IDI_Adhoc")
...
sort snz_uid
local total_N = _N
local third_of_N = round(_N/3,1)
local two_thirds_of_N = round((_N/3)*2,1)
di "`third_of_N'"
di "`two_thirds_of_N'"
gen ref_SNZ_UID_1 = snz_uid[`third_of_N'] 
gen ref_SNZ_UID_2 = snz_uid[`two_thirds_of_N']
su ref_SNZ_UID_1, meanonly
global ref_SNZ_UID_1 = r(max)
su ref_SNZ_UID_2, meanonly
global ref_SNZ_UID_2 = r(max)
restore
sort snz_uid
keep if snz_uid <= $ref_SNZ_UID_1
...
*** INSERT DATES OF INTEREST HERE 1/3
...
sort snz_uid
keep if snz_uid > $ref_SNZ_UID_1 & snz_uid <= $ref_SNZ_UID_2
...
*** INSERT DATES OF INTEREST HERE 2/3
foreach num in 29032022 22032022 15032022 08032022 01032022 22022022 15022022 08022022 01022022 25012022 18012022 11012022 04012022 28122021 21122021 14122021 07122021 30112021 23112021 16112021 09112021 02112021 26102021 19102021 12102021 05102021 28092021 21092021 14092021 07092021 31082021 24082021 17082021 10082021 03082021 27072021 20072021 13072021 06072021 29062021 22062021 15062021 08062021 01062021 25052021 18052021 11052021 04052021 27042021 20042021 13042021 06042021 30032021 23032021 16032021 09032021 02032021 23022021 16022021 09022021  {
	gen vacc_stat_as_of_`num' = 0
}
...
collapse (firstnm) actvity_1_date actvity_2_date actvity_3_date actvity_4_date actvity_5_date actvity_6_date, by(snz_uid) fast
*** INSERT DATES OF INTEREST HERE 3/3
foreach num in 29032022 22032022 15032022 08032022 01032022 22022022 15022022 08022022 01022022 25012022 18012022 11012022 04012022 28122021 21122021 14122021 07122021 30112021 23112021 16112021 09112021 02112021 26102021 19102021 12102021 05102021 28092021 21092021 14092021 07092021 31082021 24082021 17082021 10082021 03082021 27072021 20072021 13072021 06072021 29062021 22062021 15062021 08062021 01062021 25052021 18052021 11052021 04052021 27042021 20042021 13042021 06042021 30032021 23032021 16032021 09032021 02032021 23022021 16022021 09022021  {
	gen vacc_stat_as_of_`num' = 0
}
...
// DHB of service
odbc load, bigint clear exec("select snz_uid, dhb_of_service from [IDI_Sandpit].[DL-MAA2021-49].[vacc_clean_DHB_of_service_202203]") $IDISP_CONN
duplicates drop snz_uid, force
...
**** old indicator creation code..... we now utilise a dose count indicator as prescribed by Shari from MOH.
