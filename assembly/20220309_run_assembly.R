...
# file paths
ABSOLUTE_PATH_TO_TOOL <- "~/Network-Shares/DataLabNas/MAA/MAA2021-49/SWA_development/Main/tool_accelerating_dataset_assembly-master"
ABSOLUTE_PATH_TO_ANALYSIS <- "~/Network-Shares/DataLabNas/MAA/MAA2021-49/SWA_development/Main/tool_accelerating_dataset_assembly-master"
POPULATION_FILE <- "20220406_population_and_period.xlsx"
MEASURES_FILE <- "20220404_measures_v4.xlsx"

# outputs
OUTPUT_DATABASE <- "[IDI_Sandpit]"
OUTPUT_SCHEMA <- "[DL-MAA2021-49]"
LONG_THIN_TABLE_NAME <- "[tmp_vacc_assembled_data]"
RECTANGULAR_TABLE_NAME <- "[tmp_vacc_rectangular]"
